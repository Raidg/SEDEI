...
// CHECK-NEXT:     zbaxadduwd           1.0       'zba add.uw disable' (XLEN-wide addition instruction of least-significant words)
// CHECK-NEXT:     zbaxadduwe           1.0       'zba add.uw enable' (XLEN-wide addition instruction of least-significant words)
// CHECK-NEXT:     zbaxsh1addd          1.0       'zba sh1add enable' (Shift left by 1 and add)
// CHECK-NEXT:     zbaxsh1adde          1.0       'zba sh1add enable' (Shift left by 1 and add)
// CHECK-NEXT:     zbaxsh1adduwd        1.0       'zba sh1adduw enable' (Shift unsigned word left by 1 and add)
// CHECK-NEXT:     zbaxsh1adduwe        1.0       'zba sh1adduw enable' (Shift unsigned word left by 1 and add)
// CHECK-NEXT:     zbaxsh2addd          1.0       'zba sh2add enable' (Shift left by 2 and add)
// CHECK-NEXT:     zbaxsh2adde          1.0       'zba sh2add enable' (Shift left by 2 and add)
// CHECK-NEXT:     zbaxsh2adduwd        1.0       'zba sh2adduw enable' (Shift unsigned word left by 2 and add)
// CHECK-NEXT:     zbaxsh2adduwe        1.0       'zba sh2adduw enable' (Shift unsigned word left by 2 and add)
// CHECK-NEXT:     zbaxsh3addd          1.0       'zba sh3add enable' (Shift left by 2 and add)
// CHECK-NEXT:     zbaxsh3adde          1.0       'zba sh3add enable' (Shift left by 2 and add)
// CHECK-NEXT:     zbaxsh3adduwd        1.0       'zba sh3adduw enable' (Shift unsigned word left by 3 and add)
// CHECK-NEXT:     zbaxsh3adduwe        1.0       'zba sh3adduw enable' (Shift unsigned word left by 3 and add)
// CHECK-NEXT:     zbaxslliuwd          1.0       'zba slli.uw enable' (Shift-left unsigned word (Immediate))
// CHECK-NEXT:     zbaxslliuwe          1.0       'zba slli.uw enable' (Shift-left unsigned word (Immediate))
