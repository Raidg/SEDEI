...
void RISCVRegisterInfo::adjustReg(MachineBasicBlock &MBB,
  ...
  if (Offset.getScalable()) {
    ...
    if (ScalableAdjOpc == RISCV::ADD && (ST.hasStdExtZba() || ST.hasEnaZbaSh1Add() || ST.hasEnaZbaSh2Add() || ST.hasEnaZbaSh3Add()) &&
        (((NumOfVReg == 2) && (ST.hasStdExtZba() || ST.hasEnaZbaSh1Add())) || 
         ((NumOfVReg == 4) && (ST.hasStdExtZba() || ST.hasEnaZbaSh2Add())) || 
         ((NumOfVReg == 8) && (ST.hasStdExtZba() || ST.hasEnaZbaSh3Add())))) {
  ...
  if ((ST.hasStdExtZba() || (ST.hasEnaZbaSh2Add() && isShiftedInt<12, 2>(Val)) || (ST.hasEnaZbaSh3Add() && isShiftedInt<12, 3>(Val))) && (Val & 0xFFF) != 0) {
    unsigned Opc = 0;
